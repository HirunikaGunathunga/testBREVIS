...
<div class="container">
    <div class="class">
    <div class="img1">
        <img src="<?php echo URLROOT; ?>/img/c_delete.svg">
    </div>
    <form class="dform"  method="POST" action="<?php echo URLROOT; ?>/courses/deletecourse/<?php echo $data['course']->course_id; ?>" >
    <input name= "submit" type="submit" class="btn2" value="Delete Course">
    </form>
    </div>
